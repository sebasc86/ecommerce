...
$sth = $con->prepare("SELECT *, ROUND(AVG(valoracion),1) as promedio, COUNT(ranking.id_producto) as reviews, ranking.comentario FROM web.ranking
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb-tree">
                    ...
                    <li><a href="?seccion=product&idcatp=1">Accessories </a></li>
                    <li class="active"><?php echo $result["nombre"] ?></li>
                </ul>
            </div>
        </div>
        <!-- /row -->
